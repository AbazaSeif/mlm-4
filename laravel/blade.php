...
class Blade {
	...
	/**
	 * Rewrites Blade @yield_content statements into Section statements.
	 *
	 * The Blade @yield_content statement is a shortcut to the Section::yield_content method.
	 *
	 * @param  string  $value
	 * @return string
	 */
	protected static function compile_yield_contents($value)
	{
	...
	/**
	 * Rewrites Blade yield_content section statements into valid PHP.
	 *
	 * @return string
	 */
	protected static function compile_yield_content_sections($value)
	{
		$replace = '<?php echo \\Laravel\\Section::yield_content_section(); ?>';

		return str_replace('@yield_content_section', $replace, $value);
	}
