...
@section('content')
  ...
  <li class="direct" title="Google"> 
    ...
    <li class="username" title="STEAM user name"> 
		<img src="{{ URL::to_asset("images/login/steam.png") }}" alt="icon" /><span>http://steamcommunity.com/openid/id/<strong>username</strong></span></li> 	
</div>		
  <fieldset> 
...
<p>We use openID for a safe, faster, and easier way to log into our website.
		If you don't have an openID with any of the provided services, you may create one with any provider <a href="http://openid.net/get-an-openid/" title="Will open in new tab" target="_blank">on this list.</a>
</p>
		</div>
	</div>
@endsection
