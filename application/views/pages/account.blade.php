...
@include("user.menu")
	...
	<div id="multibg">
	<a href="#" data-mbg="bg-white" title="Default background"><img src="{{ URL::to_asset("images/static/bg/white.png") }}"><span>Light</span></a>
	<a href="#" data-mbg="bg-black"><img src="{{ URL::to_asset("images/static/bg/black.png") }}"><span>Dark</span></a>
	<a href="#" data-mbg="bg-red"><img src="{{ URL::to_asset("images/static/bg/red.png") }}"><span>Red</span></a>
	<a href="#" data-mbg="bg-green"><img src="{{ URL::to_asset("images/static/bg/green.png") }}"><span>Green</span></a>
	<a href="#" data-mbg="bg-blue"><img src="{{ URL::to_asset("images/static/bg/blue.png") }}"><span>Blue</span></a>
	<a href="#" data-mbg="bg-cyan"><img src="{{ URL::to_asset("images/static/bg/cyan.png") }}"><span>Cyan</span></a>
	<a href="#" data-mbg="bg-yellow"><img src="{{ URL::to_asset("images/static/bg/yellow.png") }}"><span>Yellow</span></a>
	<a href="#" data-mbg="bg-magenta"><img src="{{ URL::to_asset("images/static/bg/magenta.png") }}"><span>Magenta</span></a>
	<a href="#" data-mbg="bg-devblue" title="Background used during initial development!"><img src="{{ URL::to_asset("images/static/bg/devblue.jpg") }}" height="115"><span>Dev-Blue</span></a>
