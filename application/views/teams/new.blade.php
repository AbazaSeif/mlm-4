...
<div class="titlebar"><h2>New Team</h2></div>
{{ Form::open("teams/new", "POST", array("class" => "form")) }}
	...
	{{ Form::field("wysiwyg-user", "description", "Team bio", array(Input::old("description"), array("rows" => "15", 'class' => 'input-xxlarge')), array("help" => "Tell us about your team. What makes it great? What have you accomplished?", "error" => $errors->first("description"))) }}		
	{{ Form::field("checkbox", "private", "Private Team", array(Input::old("private")), array("help" => "Makes team viewable by members only", "error" => $errors->first("private"))) }}
