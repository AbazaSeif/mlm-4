...
<div id="page" class="bigger">
	{{ Form::open("teams/edit_meta/".$team->id, "POST", array("class" => "form")) }}
		...
		<div class="titlebar"><h4>Summary</h4></div>
		{{ Form::field("text", "summary", "", array(Input::old("summary", $team->summary)), array("rows" => "5", "error" => $errors->first("summary"))) }}
		<div class="titlebar"><h4>Team Description</h4></div>
		{{ Form::field("wysiwyg", "description", " ", array(Input::old("description", $team->description), array("rows" => "15", 'class' => 'input-xxlarge')), array("error" => $errors->first("description"))) }}		
		<div class="titlebar"><h4>Private Team (Can people view this team)</h4></div>
