...
<div id="content">
	...
	@endif
		...
		{{ Form::field("checkbox", "direct", "Direct download", array(1, Input::old("direct", $link->direct)), array("error" => $errors->first("direct"), "help" => "Indicates that URL leads straight to download. This means no redirect pages, landing pages nor ads.")) }}
