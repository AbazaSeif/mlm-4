...
<div class="titlebar">
	...
	{{ Form::open("maps/edit_meta/".$map->id, "POST", array("class" => "form")) }}
			...
			{{ Form::field("select", "mcversion", "Minecraft version", array(array_merge(array("" => "--------------"), $versions), Input::old("mcversion", $versionarrayid), array('class' => 'input')), array('error' => $errors->first('mcversion'), "help" => "The Minecraft Version for the map should be the latest version of Minecraft that the map was tested on and fully worked.")) }}
