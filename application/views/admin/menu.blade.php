...
<div id="adminmenu">
	<ul>
		...
		<li {{ URI::is('admin/user') ? 'class="active"' : '' }}><i class="icon-user"></i> {{ HTML::link("admin/user", "Users") }}</li> 
		<li {{ URI::is('admin/groups') ? 'class="active"' : '' }}><i class="icon-group"></i> {{ HTML::link("admin/groups", "Groups") }}</li> 
