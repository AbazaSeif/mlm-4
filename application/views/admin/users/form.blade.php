...
<div class="titlebar clearfix">
		...
		{{ Form::field("checkbox", "admin", "Admin", array(1, Input::old("admin", $userdata->admin), array('class' => 'checkbox')),array("help" => "Warning!: Only check this box if the user is Admin or Developer")) }}
		{{ Form::field("select", "rank", "Rank", array(array(0 => "Normal user", 1 => "Moderator", 2 => "Editor", 3 => "Developer", 4 => "Admin"), Input::old("rank", $userdata->rank)), array("help" => "Each rank has different permissons","error" => $errors->first("rank"))) }}
<div class="titlebar clearfix">
		<h3>Profile</h3>
</div>
