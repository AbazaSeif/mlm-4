...
@endif
	...
	<header id="global-header">
		...
		<div class="holder">
			...
			@elseif (Auth::check())
				{{ HTML::link_to_action('account@logout', "Logout") }} &bull; {{ HTML::link('account', 'My Settings'); }} &bull; <a href="{{ URL::to("user/".Auth::user()->username) }}">My Profile <img src="http://minotar.net/helm/{{ Auth::user()->mc_username }}/18.png" alt="avatar"></a>
			@else
